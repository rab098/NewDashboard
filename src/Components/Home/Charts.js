...
function Charts(props) {
    ...
    useEffect(() => {
        ...
        if (props.value === 'Total Complaints') {
            ...
            setHighestValue({
                highestValueDaily: Math.max.apply(null, allData.totalCountResultDaily) + 10,
                highestValueMonthly: Math.max.apply(null, allData.totalCountResultMonthly) + 10,
                highestValueYearly: Math.max.apply(null, allData.totalCountResultYearly) + 10
            })
            ...
            setHighestValue({
                highestValueDaily: Math.max.apply(null, allData.resolvedResultDaily) + 10,
                highestValueMonthly: Math.max.apply(null, allData.resolvedResultMonthly) + 10,
                highestValueYearly: Math.max.apply(null, allData.resolvedResultYearly) + 10
            })
            ...
            setHighestValue({
                highestValueDaily: Math.max.apply(null, allData.unresolvedResultDaily) + 10,
                highestValueMonthly: Math.max.apply(null, allData.unresolvedResultMonthly) + 10,
                highestValueYearly: Math.max.apply(null, allData.unresolvedResultYearly) + 10
            })
            ...
            setHighestValue({
                highestValueDaily: Math.max.apply(null, allData.assignedResultDaily) + 10,
                highestValueMonthly: Math.max.apply(null, allData.assignedResultMonthly) + 10,
                highestValueYearly: Math.max.apply(null, allData.assignedResultYearly) + 10
            })
            ...
            setHighestValue({
                highestValueDaily: Math.max.apply(null, allData.rejectedResultDaily) + 10,
                highestValueMonthly: Math.max.apply(null, allData.rejectedResultMonthly) + 10,
                highestValueYearly: Math.max.apply(null, allData.rejectedResultYearly) + 10
            })
        }
    }, [props])
